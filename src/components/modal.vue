        ...
        <ion-content class="ion-padding" fullscreen>
            <form @submit.prevent="addBook">
                <ion-item class="ion-padding-horizontal">
                    ...
                    <ion-input type="text" name="author" v-model="author" v-bind:value="author"
                               @input="author = $event.target.value"></ion-input>
                </ion-item>
                <span class="error" v-if="this.authorError">Author is required</span>
                <ion-item class="ion-padding-horizontal">
                    <ion-label position="floating">Book Title *</ion-label>
                    <ion-input type="text" name="title" v-bind:value="title"
                               @input="title = $event.target.value"></ion-input>
                </ion-item>
                <span class="error" v-if="this.titleError">Book title is required</span>
                <ion-item class="ion-padding-horizontal">
                    <ion-label position="floating">Description</ion-label>
                    <ion-textarea type="text" name="description" v-bind:value="description"
                                  @input="description = $event.target.value"></ion-textarea>
                </ion-item>
                <ion-item class="ion-padding-horizontal">
                    <ion-label position="floating">Images *</ion-label>
                    <ion-input type="url" name="imageUrl" v-bind:value="imageUrl"
                               @input="imageUrl = $event.target.value"></ion-input>
                </ion-item>
                ...
                <ion-item class="ion-padding-horizontal">
                    ...
                    <ion-input type="number" name="nbPages" v-bind:value="nbPages"
                               @input="nbPages = $event.target.value"></ion-input>
                </ion-item>
